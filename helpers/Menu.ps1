...
function Menu {
	param ([array]$menuItems, [switch]$ReturnIndex = $false, [switch]$Multiselect, [switch]$AlternativeBuffer)
	if ($UseAlternativeBuffer) {New-Buffer "Alternative"}
	function DrawMenu {
	...
	if ($UseAlternativeBuffer) {New-Buffer "Default"}
